...
/*
    ...
    Cmdline: sokol-shdc --input instancing-sapp.glsl --output instancing-sapp.glsl.h --slang glsl330
...
static const char fs_source_glsl330[114] = {
  ...
  #error "Please include sokol_gfx.h before instancing-sapp.glsl.h"
#endif
